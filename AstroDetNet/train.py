...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='/home/liuhaoan/ADTS/AstroDetNet/data/models/Ori_YOLO.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/home/liuhaoan/ADTS/AstroDetNet/data/JointBP_HumanParts.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='/home/liuhaoan/ADTS/AstroDetNet/data/hyp-p6.yaml', help='hyperparameters path')
