...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--img-path', default='/home/liuhaoan/ADTS/AstroDetNet/test_imgs/0217.jpg', help='path to image or dir')
    ...
    parser.add_argument('--weights', default='/home/liuhaoan/ADTS/AstroDetNet/runs/train/exp2/weights/best_mMR.pt')
