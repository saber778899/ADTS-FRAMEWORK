...
if __name__ == '__main__':
    ...
    # video options
    parser.add_argument('-p', '--video-path', default='/home/liuhaoan/ADTS/AstroDetNet/test_imgs/test_video_2.mp4', help='path to video file')
    ...
    parser.add_argument('--weights', default='/home/liuhaoan/ADTS/AstroDetNet/runs/train/exp43_1208/weights/best_mMR.pt')
